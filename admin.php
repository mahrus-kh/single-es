        ...
        <div class="col-md-7">
          <div class="box box-default">
            <div class="box-header with-border">
              ...
              <button type="button" class="btn btn-primary btn-sm pull-right" onclick="tambahAdmin()">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h5 class="modal-title"><div id="title-modal-admin"></div> </h5>
        </div>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-primary btn-sm" id="btnSimpanAdmin" onclick="simpanDataAdmin()">Simpan</button>
        </div>
      </div>
      <!-- /.modal-content -->
    </div>
  </div>
  <div class="modal fade" id="modalRemoveAdmin">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-body">
          Yakin hapus permanen data admin ?
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default btn-sm" data-dismiss="modal">Batal</button>
          <button type="button" class="btn btn-danger btn-sm" id="btnRemoveAdmin">Hapus</button>
        </div>
      </div>
    </div>
  </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function () {
    ...
    $('#admin-datatables tbody').on( 'click', 'button.hapus-data-admin', function (e) {
      e.stopPropagation()
      let data = dataAdmin.table.row($(this).parents('tr')).data()
      dataAdmin.selected = data.id
      dataAdmin.modalRemove.modal('toggle')
    });
